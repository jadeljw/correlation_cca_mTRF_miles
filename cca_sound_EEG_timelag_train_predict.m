...
%% timelag
timelag = -40:5:100; % Fs = 200Hz -> -200ms~500ms
% timelag = 0;
% 1 point = 5 ms
...
for j =  1 : length(timelag)
    ...
    % save
    saveName = strcat('cca_sound_EEG_result+',num2str(5*timelag(j)),'ms',band_name,'.mat');
    ...
    saveName1 = strcat('Reconstruction Accuracy using cca method for attend decoder+',num2str(5*timelag(j)),'ms',band_name,'.jpg');
    ...
    xlabel('Subject No.'); ylabel('r value')
    saveName2 = strcat('Reconstruction Accuracy using cca method for unattend decoder+',num2str(5*timelag(j)),'ms',band_name,'.jpg');
    ...
    saveName3 = strcat('Decoding accuracy using cca method for attend and unattend decoder+',num2str(5*timelag(j)),'ms',band_name,'.jpg');
