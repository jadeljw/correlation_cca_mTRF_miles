...
for bandName = 1 : length(band_name)
    ...
    %     load('E:\DataProcessing\afterICA_data\data_speaker_64Hz_bandpass_2-8Hz.mat')
    SpeakerDataName = strcat('E:\DataProcessing\afterICA_data\data_speaker_64Hz_',band_name{bandName}(2:end),'.mat');
    load(SpeakerDataName);
    ...
    for j = 1: length(timelag)
        ...
        % save
        saveName = strcat('cca_S-L_EEG_result+',num2str((1000/Fs)*timelag(j)),'ms',band_name{bandName},'.mat');
        ...
        saveName1 = strcat('Reconstruction Accuracy using S-L cca method for attend decoder+',num2str((1000/Fs)*timelag(j)),'ms',band_name{bandName},'.jpg');
        ...
        hold on; plot(mean(recon_UnattendDecoder_unattend_cca,2),'b');
        xlabel('Subject No.'); ylabel('r value')
        saveName2 = strcat('Reconstruction Accuracy using S-L cca method for unattend decoder+',num2str((1000/Fs)*timelag(j)),'ms',band_name{bandName},'.jpg');
        ...
        hold on; plot(Individual_subjects_result_unattend*100,'b');
        xlabel('Subject No.'); ylabel('Decoding Accuarcy %');ylim([0,100]);
        saveName3 = strcat('Decoding accuracy using S-L cca method for attend and unattend decoder+',num2str((1000/Fs)*timelag(j)),'ms',band_name{bandName},'.jpg');
